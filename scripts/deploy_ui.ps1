...
gcloud run deploy $SERVICE_NAME `
    ...
    --region $REGION `
    --platform managed `
    --set-env-vars "PROJECT_ID=$PROJECT_ID,DASHBOARD_PASSWORD=btc1984,DASHBOARD_PASS_1=E(nC>D8<<279oNV@,DASHBOARD_PASS_2=727C?O%yDb-G?4=N,DASHBOARD_PASS_3=1(OcJ=1j$uE`"p98I,DASHBOARD_PASS_4=%k):7J5j5MY<f/_O" `
    --quiet
